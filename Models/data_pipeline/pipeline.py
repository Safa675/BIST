...
from Models.data_pipeline.logging_utils import configure_structured_logger, log_event
from Models.data_pipeline.merge import merge_consolidated_panels
from Models.data_pipeline.normalize import (
    build_consolidated_panel,
    build_flat_normalized,
    build_staleness_weights,
    save_normalized_per_ticker_json,
)
from Models.data_pipeline.provenance import (
    file_checksum_sha256,
    stable_json_sha256,
    write_dataset_provenance,
)
from Models.data_pipeline.schemas import (
...
def compute_default_periods(count: int = 5, as_of: datetime | None = None) -> tuple[tuple[int, int], ...]:
    ...
    if month <= 3:
        ...
        start_year, start_period = year, 9
